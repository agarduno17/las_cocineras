        ...
        <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 bg-gradient-to-r from-red-600 to-red-800 rounded-2xl p-8 sm:p-12 text-center shadow-2xl">
              ...
              <a
                href="/contacto"
                className="inline-flex items-center space-x-2 bg-white text-red-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all shadow-lg whitespace-nowrap cursor-pointer"
              >
