                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <a
                      ...
                      className="block w-full bg-gradient-to-r from-red-600 to-red-800 text-white py-3 rounded-lg font-semibold hover:from-red-700 hover:to-red-900 transition-all whitespace-nowrap cursor-pointer text-center mt-auto"
                    >
