              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Palillos para botanas y canapés">Palillos para botanas y canapés</option>
                    <option value="Palillos tipo banderilla y brochetas">Palillos tipo banderilla y brochetas</option>
                    <option value="Palillos para elotes">Palillos para elotes</option>
                    <option value="Cucharas de madera para helados">Cucharas de madera para helados</option>
                    <option value="Palillos para paletas">Palillos para paletas</option>
                    <option value="Abatelenguas">Abatelenguas</option>
